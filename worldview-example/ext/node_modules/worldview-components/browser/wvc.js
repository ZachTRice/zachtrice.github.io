...
},{"./input-range":15}],14:[function(require,module,exports){
'use strict';
...
},{"./input-range":16}],16:[function(require,module,exports){
(function (global){
'use strict';
...
},{"../utils":27,"./default-class-names":14,"./key-codes":17,"./label":18,"./range-prop-type":19,"./slider":20,"./track":21,"./value-prop-type":22,"./value-transformer":23,"autobind-decorator":1}],17:[function(require,module,exports){
"use strict";
...
},{"./label":18,"autobind-decorator":1}],21:[function(require,module,exports){
(function (global){
'use strict';
...
},{"autobind-decorator":1}],22:[function(require,module,exports){
'use strict';
...
},{"./captialize":24,"./clamp":25,"./distance-to":26,"./is-defined":28,"./is-number":29,"./is-object":30,"./length":31}],28:[function(require,module,exports){
"use strict";
...
animWidgetHeader.propTypes = {
  ...
  toolTipTextArray: _propTypes2.default.array
};
...
},{"../tooltip/wv.tooltip":48,"prop-types":10}],34:[function(require,module,exports){
(function (global){
'use strict';
...
AnimationWidget.propTypes = {
  sliderSpeed: _propTypes2.default.number,
  looping: _propTypes2.default.bool,
  startDate: _propTypes2.default.object,
  endDate: _propTypes2.default.object,
  header: _propTypes2.default.element,
  incrementArray: _propTypes2.default.array,
  increment: _propTypes2.default.string,
  onSlide: _propTypes2.default.func,
  onPushPlay: _propTypes2.default.func,
  onPushPause: _propTypes2.default.func,
  onPushLoop: _propTypes2.default.func,
  onDateChange: _propTypes2.default.func,
  onZoomSelect: _propTypes2.default.func,
  sliderLabel: _propTypes2.default.string,
  onPushGIF: _propTypes2.default.func,
...
},{"../dateselector/wv.dateselector":40,"./wv.animation.widget.header":33,"./wv.loopbutton":35,"./wv.playbutton":36,"prop-types":10,"react-input-range":13}],35:[function(require,module,exports){
(function (global){
'use strict';
...
LoopButton.propTypes = {
  looping: _propTypes2.default.bool,
  onLoop: _propTypes2.default.func
};
...
},{"prop-types":10}],36:[function(require,module,exports){
(function (global){
'use strict';
...
},{"prop-types":10}],37:[function(require,module,exports){
(function (global){
'use strict';
...
Line.propTypes = {
  dashArray: _propTypes2.default.string,
  opacity: _propTypes2.default.string,
  width: _propTypes2.default.string,
  strokeWidth: _propTypes2.default.string,
  color: _propTypes2.default.string,
  height: _propTypes2.default.number,
  lineX: _propTypes2.default.number,
  lineOver: _propTypes2.default.func,
  lineOut: _propTypes2.default.func,
...
},{"prop-types":10}],38:[function(require,module,exports){
(function (global){
'use strict';
...
LineText.propTypes = {
  ...
  rectOpacity: _propTypes2.default.number,
  width: _propTypes2.default.string,
  color: _propTypes2.default.string,
  textY: _propTypes2.default.number,
  fill: _propTypes2.default.string,
  dateLeft: _propTypes2.default.string,
  dateRight: _propTypes2.default.string,
  x2: _propTypes2.default.number,
  x1: _propTypes2.default.number,
  textWidth: _propTypes2.default.number,
  textHeight: _propTypes2.default.number,
  recRadius: _propTypes2.default.number,
  svgStyle: _propTypes2.default.object
};
...
},{"prop-types":10}],39:[function(require,module,exports){
(function (global){
'use strict';
...
DateInputColumn.propTypes = {
  ...
  updateDate: _propTypes2.default.func,
  date: _propTypes2.default.object,
  minDate: _propTypes2.default.object,
  maxDate: _propTypes2.default.object,
  blur: _propTypes2.default.func,
  nextTab: _propTypes2.default.func,
...
},{"../util/wv.utils":50,"prop-types":10}],40:[function(require,module,exports){
(function (global){
'use strict';
...
},{"../util/wv.utils":50,"./wv.dateselector.input":39,"prop-types":10}],41:[function(require,module,exports){
(function (global){
'use strict';
...
var _wvLayerRow = require('./wv.layer.row.js');

var _wvLayerRow2 = _interopRequireDefault(_wvLayerRow);
...
var LayerList = function (_React$Component) {
  ...
  _createClass(LayerList, [{
    key: 'toggleExpansion',
    value: function toggleExpansion(layerId) {
      var _this2 = this;

      var _state = this.state,
          filteredLayers = _state.filteredLayers,
          expandedLayers = _state.expandedLayers;

      var isExpanded = expandedLayers.find(function (id) {
        return id === layerId;
      });
      if (isExpanded) {
        expandedLayers = expandedLayers.filter(function (id) {
          return id !== layerId;
        });
      } else {
        expandedLayers.push(layerId);
        this.setState({ expandedLayers: expandedLayers });
        var layer = filteredLayers.find(function (l) {
          return l.id === layerId;
        });
        if (!layer.metadata) {
          ...
          fetch(uri).then(function (res) {
            return res.ok ? res.text() : errorMessage;
          }).then(function (body) {
            ...
            _this2.setState({ layers: filteredLayers });
          });
        }
      }
    }
    ...
    value: function render() {
      ...
      var _state2 = this.state,
          filteredLayers = _state2.filteredLayers,
          expandedLayers = _state2.expandedLayers,
          activeLayers = _state2.activeLayers;
      var _props = this.props,
          addLayer = _props.addLayer,
      ...
      return _react2.default.createElement(
        ...
        filteredLayers.length < 1 ? _react2.default.createElement(
          'div',
          null,
          'No results.'
        ) : null,
        filteredLayers.map(function (layer) {
          var isEnabled = activeLayers.some(function (l) {
            return l.id === layer.id;
          });
          var isExpanded = expandedLayers.includes(layer.id);
          return _react2.default.createElement(_wvLayerRow2.default, {
            key: layer.id,
            layer: layer,
            isEnabled: isEnabled,
            ...
            toggleExpansion: function toggleExpansion(id) {
              return _this3.toggleExpansion(id);
            }
          });
        })
      );
...
LayerList.propTypes = {
  addLayer: _propTypes2.default.func,
  removeLayer: _propTypes2.default.func,
  activeLayers: _propTypes2.default.array,
  filteredLayers: _propTypes2.default.array
};
...
},{"./wv.layer.row.js":42,"prop-types":10,"whatwg-fetch":32}],42:[function(require,module,exports){
(function (global){
'use strict';
 ...
 * @extends React.Component
 */
var LayerRow = function (_React$Component) {
  _inherits(LayerRow, _React$Component);

  function LayerRow(props) {
    _classCallCheck(this, LayerRow);

    var _this = _possibleConstructorReturn(this, (LayerRow.__proto__ || Object.getPrototypeOf(LayerRow)).call(this, props));
  ...
  _createClass(LayerRow, [{
    key: 'toggleCheck',
    value: function toggleCheck() {
      var checked = this.state.checked;
      var _props = this.props,
          onState = _props.onState,
          offState = _props.offState,
          layer = _props.layer;
    ...
    key: 'toggleMetadataButtons',
    value: function toggleMetadataButtons(e) {
      e.stopPropagation(); // Prevent layer from being activated
      var _props2 = this.props,
          layer = _props2.layer,
          toggleExpansion = _props2.toggleExpansion;
    ...
    value: function render() {
      ...
      return _react2.default.createElement(
        ...
        _react2.default.createElement(
          'div',
          { className: headerClass, onClick: function onClick() {
          ...
          _react2.default.createElement(
            ...
            null,
            title,
            description && _react2.default.createElement('span', {
              className: 'fa fa-info-circle',
              onClick: function onClick(e) {
                return _this2.toggleMetadataButtons(e);
              }
            })
          ),
        ...
        isExpanded && metadata && _react2.default.createElement(
          'div',
          { className: 'source-metadata visible' },
          _react2.default.createElement('div', { dangerouslySetInnerHTML: { __html: metadata } }),
          _react2.default.createElement(
            'div',
            { className: 'metadata-more', onClick: function onClick(e) {
                return _this2.toggleMetadataButtons(e);
              } },
            _react2.default.createElement(
              'span',
...
LayerRow.propTypes = {
  ...
  onState: _propTypes2.default.func,
  offState: _propTypes2.default.func,
  toggleExpansion: _propTypes2.default.func
};

exports.default = LayerRow;

}).call(this,typeof global !== "undefined" ? global : typeof self !== "undefined" ? self : typeof window !== "undefined" ? window : {})

},{"prop-types":10}],43:[function(require,module,exports){
(function (global){
'use strict';
...
TimelineDragger.propTypes = {
  ...
  startLocation: _propTypes2.default.number,
  endLocation: _propTypes2.default.number,
  ...
  triangleColor: _propTypes2.default.string
};
...
},{"prop-types":10,"react-draggable":12}],44:[function(require,module,exports){
(function (global){
'use strict';
...
},{"prop-types":10}],45:[function(require,module,exports){
(function (global){
'use strict';
...
TimelineRangeSelector.propTypes = {
  ...
  endLocation: _propTypes2.default.number,
  max: _propTypes2.default.number,
  pinWidth: _propTypes2.default.number,
  height: _propTypes2.default.number,
  onDrag: _propTypes2.default.func,
  onRangeClick: _propTypes2.default.func,
  rangeOpacity: _propTypes2.default.number,
  rangeColor: _propTypes2.default.string,
  startColor: _propTypes2.default.string,
  startTriangleColor: _propTypes2.default.string,
  endColor: _propTypes2.default.string,
  endTriangleColor: _propTypes2.default.string
};
...
},{"./wv.timeline.dragger.js":43,"./wv.timeline.draggerrange.js":44,"prop-types":10}],46:[function(require,module,exports){
(function (global){
'use strict';
...
Share.propTypes = {
  fbLink: _propTypes2.default.string,
  twLink: _propTypes2.default.string,
  rdLink: _propTypes2.default.string,
  emailLink: _propTypes2.default.string,
  clickFunction: _propTypes2.default.func
};
...
},{"./wv.share.links":47,"prop-types":10}],47:[function(require,module,exports){
(function (global){
'use strict';
...
},{"prop-types":10}],48:[function(require,module,exports){
(function (global){
'use strict';
...
Tooltip.propTypes = {
  ...
  dataArray: _propTypes2.default.array.isRequired
};
...
},{"prop-types":10}],49:[function(require,module,exports){
'use strict';
...
var _wvLayerRow = require('./components/layer/wv.layer.row.js');

Object.defineProperty(exports, 'LayerRow', {
  enumerable: true,
  get: function get() {
    return _interopRequireDefault(_wvLayerRow).default;
  }
});

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

},{"./components/animationwidget/wv.animation.widget.js":34,"./components/dateline/wv.line.js":37,"./components/dateline/wv.linetext.js":38,"./components/dateselector/wv.dateselector.js":40,"./components/layer/wv.layer.list.js":41,"./components/layer/wv.layer.row.js":42,"./components/rangeselection/wv.timeline.rangeselection.js":45,"./components/share/wv.share.js":46,"./components/tooltip/wv.tooltip.js":48,"./components/util/wv.googleAnalytics.js":49,"./components/util/wv.utils.js":50}]},{},[51])(51)
});
